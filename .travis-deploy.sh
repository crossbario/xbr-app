...
# android mobile
#
aws s3 cp --acl public-read ./mobile/build/outputs/apk/release/mobile-release-unsigned.apk s3://${AWS_S3_BUCKET_NAME}/xbr-is-gold/android-mobile/xbr-is-gold-${CROSSBAR_BUILD_ID}.apk
...
# android wear
#
aws s3 cp --acl public-read ./wear/build/outputs/apk/release/wear-release-unsigned.apk s3://${AWS_S3_BUCKET_NAME}/xbr-is-gold/android-wear/xbr-is-gold-${CROSSBAR_BUILD_ID}.apk
